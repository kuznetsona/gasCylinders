...
class CameraDynamicFields:
    def __init__(self, camera, capture, timer):
        self.camera = camera
        self.captue = capture
        self.timer = timer
...
class CameraWindow(QMainWindow):
    def __init__(self):
        ...
        self.camera_name_to_device_name = {
            "Camera 1": r"@device:pnp:\\?\usb#vid_32e6&pid_9005&mi_00#6&38ab8a22&0&0000#{65e8773d-8f56-11d0-a3b9-00a0c9223196}\global",
            "Camera 2": r"@device:pnp:\\?\usb#vid_1902&pid_8301&mi_00#7&31f31a10&0&0000#{65e8773d-8f56-11d0-a3b9-00a0c9223196}\global",
        ...
        self.cameras: Dict[str, CameraDynamicFields] = {}
        ...
        self.camera_connected: Dict[str, bool] = {}
    ...
    def init_camera(self, camera_name, video_containers):
        ...
        self.cameras[camera_name] = CameraDynamicFields(**{'camera': camera, 'capture': capture, 'timer': timer})

    def handle_camera_status_change(self, camera_name, status):
        print(f'{camera_name}: status = {status} changed')
        # self.camera_connected[camera_name] = True
    ...
    def search_for_camera(self, camera_name):
        camera_device = self.camera_name_to_device_name.get(camera_name)
        ...
        for camera_info in available_cameras:
            if camera_info.deviceName() == camera_device:
                ...
                self.init_camera(
                    ...
                    video_containers=self.videoContainers_list[self.camera_name_list.index(camera_name)]
                )
    ...
    def inform_user_and_search_camera(self, camera_name):
        print('informing user and searching camera')
        ...
        self.search_timer.start(3 * 1e3)

    def get_camera_by_name(self, camera_name):
        device_name = self.camera_name_to_device_name.get(camera_name)
        if device_name:
    ...
    def save_frames(self):
        name_list = ['00_M18X1.5', '01_CN_ZN', '02_id000494', '03_MN',
